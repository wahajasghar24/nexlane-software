...
export async function GET(request: Request) {
  try {
    ...
    const data = await accountingService.listJournalEntries(context.companyId, query)
...
export async function POST(request: Request) {
  try {
    ...
    const data = await accountingService.createJournalEntry(context.companyId, body, context.userId)
