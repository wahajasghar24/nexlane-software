              ...
              {departments.map(dep => (
                <tr key={dep.id} className="border-b last:border-b-0 hover:bg-muted/30">
                  ...
                  <td className="p-3 text-right">
                    <button onClick={() => openEdit(dep)} className="text-sm text-muted-foreground hover:text-primary mr-2">Edit</button>
                    <button onClick={() => handleDelete(dep.id)} className="text-sm text-destructive hover:text-destructive/80">Delete</button>
                  </td>
                </tr>
              ))}
            </tbody>
